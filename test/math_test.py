...
#        self.s2 = random()
    ...
    def testAttributeAccess(self):
        ...
        self.v1 = Vector2(3.141, 2.718)
        self.assertEqual(self.v1.x(), 3.141)
        self.assertEqual(self.v1.y(), 2.718)
        def assign_nonfloat():
            v = Vector2("spam", "eggs")
        self.assertRaises(ValueError, assign_nonfloat)
    ...
    def testSequence(self):
        ...
        def assignIndex(idx, val):
            v[idx] = val
        self.assertRaises(TypeError, assignIndex, 0, 5.6)
        self.assertRaises(TypeError, assignIndex, 1, 7.8)
        def assignSlice():
            v = Vector2()
            v[:] = [9.1, 11.12]
        self.assertRaises(TypeError, assignSlice)
        def overpopulate():
            v = Vector2()
            v[:] = [1, 2, 3]
        ...
        def underpopulate():
            v = Vector2()
            v[:] = [1]
        self.assertRaises(TypeError, underpopulate)
        def assign_nonfloat():
            v = Vector2()
            v[0] = "spam"
    ...
    def testExtendedSlicing(self):
        ...
        #  assignment
        def sliceAssignment1():
            Vector2()[::2] = [-1]
        self.assertRaises(TypeError, sliceAssignment1)
        def sliceAssignment2():
            Vector2()[::-2] = [10]
        self.assertRaises(TypeError, sliceAssignment2)
        def sliceAssignment3():
            Vector2()[::-1] = v
        self.assertRaises(TypeError, sliceAssignment3)
        def sliceAssignment4():
            Vector2()[1:2] = [2.2]
        self.assertRaises(TypeError, sliceAssignment4)
        def sliceAssignment5():
            Vector2()[slice(1,2)] = [2.2]
        self.assertRaises(TypeError, sliceAssignment5)
        def sliceAssignment6():
            Vector2()[1:2:] = (2.2,)
        self.assertRaises(TypeError, sliceAssignment6)
    ...
    def testSwizzle(self):
        ...
        def assignSwizzle1():
            Vector2().xy = self.t2
        self.assertRaises(AttributeError, assignSwizzle1)
        def assignSwizzle2():
            Vector2().yx = self.t2
        self.assertRaises(AttributeError, assignSwizzle2)
        def invalidSwizzleX():
            Vector2().xx = (1, 2)
        def invalidSwizzleY():
            Vector2().yy = (1, 2)
    ...
    def test_polar(self):
        v = Vector2.from_polar(self.v1.as_polar())
        ...
        v = Vector2.from_polar((.5, 90))
        self.assertEqual(v, .5 * self.e2)
        v = Vector2.from_polar((1, 0))
...
#        self.s2 = random()
    ...
    def testAttributAccess(self):
        ...
        self.v1 = Vector3(3.141, 2.718, -10)
        self.assertEqual(self.v1.x(), 3.141)
        self.assertEqual(self.v1.y(), 2.718)
        self.assertEqual(self.v1.z(), -10)
        def assign_nonfloat():
            v = Vector3("spam", "eggs", "fnord")
        self.assertRaises(ValueError, assign_nonfloat)
    ...
    def testSequence(self):
        ...
        self.assertRaises(TypeError, assignIndex, 0, 5.6)
        self.assertRaises(TypeError, assignIndex, 1, 7.8)
        self.assertRaises(TypeError, assignIndex, 2, -2.1)
        def assignSlice():
            v = Vector3()
            v[:] = [9.1, 11.12, -13.41]
        self.assertRaises(TypeError, assignSlice)
    ...
    def test_scale_to_length(self):
        v = Vector3(1, 1, 1).scale_to_length(2.5)
        w = Vector3(1, 1, 1).scale_to_length(2.5)
        self.assertEqual(v, Vector3(2.5, 2.5, 2.5) / math.sqrt(3))
        self.assertRaises(ValueError, lambda : self.zeroVec.scale_to_length(1))
        self.assertEqual(v.scale_to_length(0), self.zeroVec)
        self.assertEqual(v, w)
    ...
    def testSwizzle(self):
        ...
        def swizzleAssignment1():
            Vector3().xyz = self.t2
        self.assertRaises(AttributeError, swizzleAssignment1)
        def swizzleAssignment2():
            Vector3().zxy = self.t2
        self.assertRaises(AttributeError, swizzleAssignment2)
        def swizzleAssignment3():
            Vector3().yz = self.t2[:2]
        self.assertRaises(AttributeError, swizzleAssignment3)
        def invalidSwizzleX():
            Vector3().xx = (1, 2)
        def invalidSwizzleY():
            Vector3().yy = (1, 2)
        ...
        def invalidAssignment():
            Vector3().xy = 3
        self.assertRaises(AttributeError, invalidAssignment)
    ...
    def test_spherical(self):
        v = Vector3.from_spherical(self.v1.as_spherical())
        self.assertEqual(self.v1, v)
        ...
        v = Vector3.from_spherical((.5, 90, 90))
        self.assertEqual(v, .5 * self.e2)
        # does not change self
        v.from_spherical((1, 0, 90))
        self.assertEqual(v, .5 * self.e2)
