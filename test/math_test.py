...
class MathTest (unittest.TestCase):
    ...
    def todo_test_pygame2_math_base_Vector3_rotate(self):
    ...
    def todo_test_pygame2_math_base_Vector3_rotate_ip(self):
    ...
    def todo_test_pygame2_math_base_Vector3_rotate_x(self):
    ...
    def todo_test_pygame2_math_base_Vector3_rotate_x_ip(self):
    ...
    def todo_test_pygame2_math_base_Vector3_rotate_y(self):
    ...
    def todo_test_pygame2_math_base_Vector3_rotate_y_ip(self):
    ...
    def todo_test_pygame2_math_base_Vector3_rotate_z(self):
    ...
    def todo_test_pygame2_math_base_Vector3_rotate_z_ip(self):
    ...
    def todo_test_pygame2_math_base_vector_from_spherical(self):
