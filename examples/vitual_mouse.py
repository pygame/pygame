...
while Running:
	...
	display.fill((0,0,0))
	y = draw_text_line('visible = {}: left click to toggle'.format(visible), 50)
	y = draw_text_line('grabbed = {}: right click to toggle'.format(grabbed), y)
	draw_text_line('x={}, y={}'.format(virtualx, virtualy), y)
