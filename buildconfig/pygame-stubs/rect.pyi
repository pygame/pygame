...
class Rect(object):
    ...
    @overload
    def __init__(self, left_top: Union[List[float], Tuple[float, float], Vector2], width_height: Union[List[float], Tuple[float, float], Vector2]) -> None: ...
    @overload
    ...
    @overload
    def clamp(self, left_top: Union[List[float], Tuple[float, float], Vector2], width_height: Union[List[float], Tuple[float, float], Vector2]) -> Rect: ...
    @overload
    def clamp(self, left: float, top: float, width: float, height: float) -> Rect: ...
    @overload
    def clamp_ip(self, rect: Union[_RectStyle, Rect]) -> None: ...
    @overload
    def clamp_ip(self, left_top: Union[List[float], Tuple[float, float], Vector2], width_height: Union[List[float], Tuple[float, float], Vector2]) -> None: ...
    @overload
    def clamp_ip(self, left: float, top: float, width: float, height: float) -> None: ...
    @overload
    def clip(self, rect: Union[_RectStyle, Rect]) -> Rect: ...
    @overload
    def clip(self, left_top: Union[List[float], Tuple[float, float], Vector2], width_height: Union[List[float], Tuple[float, float], Vector2]) -> Rect: ...
    @overload
    ...
    @overload
    def union(self, left_top: Union[List[float], Tuple[float, float], Vector2], width_height: Union[List[float], Tuple[float, float], Vector2]) -> Rect: ...
    @overload
    def union(self, left: float, top: float, width: float, height: float) -> Rect: ...
    @overload
    def union_ip(self, rect: Union[_RectStyle, Rect]) -> None: ...
    @overload
    def union_ip(self, left_top: Union[List[float], Tuple[float, float], Vector2], width_height: Union[List[float], Tuple[float, float], Vector2]) -> None: ...
    @overload
    ...
    @overload
    def fit(self, left_top: Union[List[float], Tuple[float, float], Vector2], width_height: Union[List[float], Tuple[float, float], Vector2]) -> Rect: ...
    @overload
    ...
    @overload
    def contains(self, left_top: Union[List[float], Tuple[float, float], Vector2], width_height: Union[List[float], Tuple[float, float], Vector2]) -> int: ...
    @overload
    ...
    @overload
    def colliderect(self, left_top: Union[List[float], Tuple[float, float], Vector2], width_height: Union[List[float], Tuple[float, float], Vector2]) -> int: ...
    @overload
