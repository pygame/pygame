...
class Rect(object):
    ...
    @overload
    def clamp(self, rect: Union[CanBeRect, Rect]) -> Rect: ...
    @overload
    def clamp(
        self,
        left_top: Union[List[float], Tuple[float, float], Vector2],
    ...
    @overload
    def clamp_ip(self, rect: Union[CanBeRect, Rect]) -> None: ...
    @overload
    def clamp_ip(
        self,
        left_top: Union[List[float], Tuple[float, float], Vector2],
    ...
    @overload
    def clip(self, rect: Union[CanBeRect, Rect]) -> Rect: ...
    @overload
    def clip(
        self,
        left_top: Union[List[float], Tuple[float, float], Vector2],
    ...
    @overload
    def union(self, rect: Union[CanBeRect, Rect]) -> Rect: ...
    @overload
    def union(
        self,
        left_top: Union[List[float], Tuple[float, float], Vector2],
    ...
    @overload
    def union_ip(self, rect: Union[CanBeRect, Rect]) -> None: ...
    @overload
    def union_ip(
        self,
        left_top: Union[List[float], Tuple[float, float], Vector2],
    ...
    def unionall(self, rect: Sequence[Union[CanBeRect, Rect]]) -> Rect: ...
    def unionall_ip(self, rect_sequence: Sequence[Union[CanBeRect, Rect]]) -> None: ...
    @overload
    def fit(self, rect: Union[CanBeRect, Rect]) -> Rect: ...
    @overload
    def fit(
        self,
        left_top: Union[List[float], Tuple[float, float], Vector2],
    ...
    @overload
    def contains(self, rect: Union[CanBeRect, Rect]) -> bool: ...
    @overload
    def contains(
        self,
        left_top: Union[List[float], Tuple[float, float], Vector2],
    ...
    @overload
    def colliderect(self, rect: Union[CanBeRect, Rect]) -> bool: ...
    @overload
    def colliderect(
        self,
        left_top: Union[List[float], Tuple[float, float], Vector2],
