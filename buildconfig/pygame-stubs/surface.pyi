...
class Surface:
    ...
    def blit(
        self, source: Surface, dest: Union[Sequence[float], Rect], area: Optional[Rect] = ..., special_flags: int = ...,
    ) -> Rect: ...
    def blits(self, sequence: Sequence[Union[Surface, Rect]], doreturn: Union[int, bool]) -> Union[Sequence[Rect], None]: ...
    @overload
    ...
    def fill(self, color: _ColorInput, rect: Optional[_RectStyle] = ..., special_flags: int = ...,) -> Rect: ...
    ...
    def get_palette(self) -> Sequence[_RgbaOutput]: ...
    ...
    def get_rect(self, **kwargs: Any) -> Rect: ...  # this needs to be Any. Applied to any attribute. eg. center - Tuple
