...
def fromstring(string: str, size: Union[List[int], Tuple[int, int]], format: str, flipped: Optional[bool]=False) -> Surface: ...
def frombuffer(string: str, size: Union[List[int], Tuple[int, int]], format: str) -> Surface: ...