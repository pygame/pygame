...
_Bitmap = Tuple[Tuple[int, int], Tuple[int, int],
...
_Big_string = Tuple[str, str, str, str, str, str, str, str, str, str, str, str,
...
def compile(strings: Sequence[str], black: Optional[str]='X', white: Optional[str]='.', xor='o') -> Tuple[Sequence[int], Sequence[int]]: ...
