...
_ColorValue = Union[Color, int, Tuple[int, int, int], Tuple[int, int, int, int], List[int]]


def init() -> None: ...
def quit() -> None: ...
def get_init() -> bool: ...
def set_mode(size: Optional[Union[Tuple[int, int], Sequence[int]]], flags: Optional[int]=0, depth: Optional[int]=0, display: Optional[int]=0) -> Surface: ...
def get_surface() -> Surface: ...
def flip() -> None: ...
def update(rectangle: Optional[Union[_RectValue, List[_RectValue]]]=None) -> None: ...
def get_driver() -> str: ...
def get_wm_info() -> Dict[str, int]: ...
def list_modes(depth: Optional[int]=0, flags: Optional[int]=-2147483648, display: Optional[int]=0) -> List[Tuple[int, int]]: ...
def mode_ok(size: Union[Sequence[int], Tuple[int, int]], flags: Optional[int]=0, depth: Optional[int]=0, display: Optional[int]=0) -> int: ...
