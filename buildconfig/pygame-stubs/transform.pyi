...
def scale(surface: Surface, size: Union[Tuple[int, int], List[int]], dest_surface: Optional[Surface]=None) -> Surface: ...
...
def smoothscale(surface: Surface, size: Union[Tuple[int, int], List[int]], dest_surface: Optional[Surface]=None) -> Surface: ...
...
def average_surfaces(surfaces: Sequence[Surface], dest_surface: Optional[Surface]=None, palette_colors: Optional[Union[bool, int]]=1) -> Surface: ...
def average_color(surface: Surface, rect: Optional[_RectValue]) -> Color: ...
def threshold(dest_surface: Surface, surf: Surface, search_color: _ColorValue, threshold: Optional[_ColorValue]=(0, 0, 0, 0), set_color: Optional[_ColorValue]=(0, 0, 0, 0), set_behavior: Optional[int]=1, search_surf: Optional[Surface]=None, inverse_set: Optional[bool]=False) -> int: ...
