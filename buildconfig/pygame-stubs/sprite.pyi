from typing import List, Dict, Any, overload, Union, Tuple, Optional, Callable
...
class LayeredUpdates(AbstractGroup):
    ...
    def draw(self, surface: Surface) -> List[Rect]: ...
    def get_sprites_at(self, pos: Union[Tuple[int, int], List[int]]) -> List[Sprite]: ...
...
class LayeredDirty(LayeredUpdates):
    def __init__(self, *sprites: DirtySprite, **kwargs: Dict[str, Any]):
        LayeredUpdates.__init__(*sprites, **kwargs)
    ...
    def set_timing_treshold(self, time_ms: Any) -> None: ...  # This actually accept any value
...
def spritecollide(sprite: Sprite, group: AbstractGroup, dokill: bool, collided: Optional[Callable[[Sprite, Sprite], bool]]=None) -> List[Sprite]: ...
...
def groupcollide(group1: AbstractGroup, group2: AbstractGroup, dokill: bool, dokill2: bool, collided: Optional[Callable[[Sprite, Sprite], bool]]=None) -> Dict[Sprite, Sprite]: ...
def spritecollideany(sprite: Sprite, group: AbstractGroup, collided: Optional[Callable[[Sprite, Sprite], bool]]=None) -> Sprite: ...
