...
def match_font(name: str, bold: Optional[bool]=False, italic: Optional[bool]=False) -> str: ...
def SysFont(name: str, size: int, bold: Optional[bool]=False, italic: Optional[bool]=False) -> Font: ...
class Font(object):
