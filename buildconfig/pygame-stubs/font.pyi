...
class Font(object):
    ...
    def set_underline(self, value: int) -> None: ...
    def get_underline(self) -> int: ...
    def set_bold(self, value: int) -> None: ...
    def get_bold(self) -> int: ...
    def set_italic(self, value: int) -> None: ...
