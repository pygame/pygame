...
class Font:
    ...
    italic: bool
    underline: bool
    def __init__(self, name: Union[str, IO[bytes], None], size: int) -> None: ...
    def render(self, text: str, antialias: bool, color: _ColorValue, background: Optional[_ColorValue] = ...) -> Surface: ...
