...
def from_surface(surface: Surface, threshold: Optional[int] = ...) -> Mask: ...
def from_threshold(
    surface: Surface,
    color: _ColorValue,
    threshold: Optional[_ColorValue] = ...,
    other_surface: Optional[Surface] = ...,
...
class Mask:
    ...
    def outline(self, every: Optional[int] = ...) -> Sequence[Tuple[int, int]]: ...
    ...
    def connected_components(self, min: Optional[int] = ...) -> Sequence[Mask]: ...
    def get_bounding_rects(self) -> Rect: ...
    def to_surface(
        self,
        surface: Optional[Surface] = ...,
        setsurface: Optional[Surface] = ...,
        unsetsurface: Optional[Surface] = ...,
