...
class Mask:
    ...
    def overlap_area(self, othermask: Mask, offset: _Coordinate) -> int: ...
    def overlap_mask(self, othermask: Mask, offset: _Coordinate) -> Mask: ...
    def fill(self) -> None: ...
    def clear(self) -> None: ...
    def invert(self) -> None: ...
    def scale(self, size: _Coordinate) -> Mask: ...
    def draw(self, othermask: Mask, offset: _Coordinate) -> None: ...
    def erase(self, othermask: Mask, offset: _Coordinate) -> None: ...
    def count(self) -> int: ...
