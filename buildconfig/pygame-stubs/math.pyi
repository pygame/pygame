...
class Vector2:
    ...
    def move_towards_ip(self, target: Vector2, distance: float) -> None: ...
    def update(
        self,
...
class Vector3:
    ...
    def move_towards(self, target: Vector3, distance: float) -> Vector3: ...
    def move_towards_ip(self, target: Vector3, distance: float) -> None: ...
    @overload
    def update(
        self,
        xyz: Union[float, Tuple[float, float, float], List[float], Vector3] = 0,
