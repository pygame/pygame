...
class Vector2:
    ...
    @overload
    def clamp_magnitude(self, max: float) -> Vector2: ...
    @overload
    def clamp_magnitude(self, min: float, max: float) -> Vector2: ...
    @overload
    def clamp_magnitude_ip(self, max: float) -> None: ...
    @overload
    def clamp_magnitude_ip(self, min: float, max: float) -> None: ...
    def update(
        self,
...
class Vector3:
    ...
    @overload
    def clamp_magnitude(self, max: float) -> Vector3: ...
    @overload
    def clamp_magnitude(self, min: float, max: float) -> Vector3: ...
    @overload
    def clamp_magnitude_ip(self, max: float) -> None: ...
    @overload
    def clamp_magnitude_ip(self, min: float, max: float) -> None: ...
