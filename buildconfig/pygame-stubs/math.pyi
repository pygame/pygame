...
class Vector3:
    ...
    z: float
    @overload
    def __init__(self, xyz: Optional[float, Tuple[float, float, float], List[float], Vector3]=0) -> None: ...
    @overload
    ...
    @overload
    def update(self, xyz: Optional[float, Tuple[float, float, float], List[float], Vector3]=0) -> None: ...
    @overload
