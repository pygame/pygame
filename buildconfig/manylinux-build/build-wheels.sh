...
if [[ "$1" == "buildpypy" ]]; then
    export SUPPORTED_PYTHONS="cp36-cp36m cp37-cp37m cp38-cp38 cp39-cp39 cp310-cp310 cp311-cp311 cp312-cp312 cp313-cp313 cp314-cp314 pp39-pypy39_pp73"
    ...
    if [ `uname -m` == "aarch64" ] || [ `uname -m` == "ppc64le" ]; then
       export SUPPORTED_PYTHONS="cp36-cp36m cp37-cp37m cp38-cp38 cp39-cp39 cp310-cp310 cp311-cp311 cp312-cp312 cp313-cp313 cp314-cp314"
    else
