...
class FRect:
    ...
    def __len__(self) -> Literal[4]: ...
    @overload
    def __getitem__(self, i: float) -> float: ...
    @overload
    def __getitem__(self, s: slice) -> List[float]: ...
    @overload
    def __setitem__(self, key: float, value: float) -> None: ...
    @overload
    def __setitem__(self, key: slice, value: Union[float, Rect]) -> None: ...
    ...
    def normalize(self) -> None: ...
    def __contains__(self, rect: Union[RectValue, float]) -> bool: ...
    @overload
    def contains(self, rect: RectValue) -> bool: ...
    @overload
    def contains(self, left_top: Coordinate, width_height: Coordinate) -> bool: ...
    ...
    @overload
    def collidedict(
        self, rect_dict: Dict[_K, Union["FRect", "Rect"]], values: bool
    ) -> Tuple[_K, Union["FRect", "Rect"]]: ...
    @overload
    def collidedictall(
        self, rect_dict: Dict[RectValue, _V], values: bool = ...
    ) -> List[Tuple[RectValue, _V]]: ...
    ...
    def collidedictall(
        self, rect_dict: Dict[_K, Union["FRect", "Rect"]], values: bool
    ) -> List[Tuple[_K, Union["FRect", "Rect"]]]: ...
