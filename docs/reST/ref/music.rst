...
.. function:: rewind
   ...
   .. note:: rewind does not support all music file formats. This is a limitation
             in the SDL_mixer, which states rewind only supports ``MOD``, ``OGG``,
             ``MP3`` and Native MIDI files. 
