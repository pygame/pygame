...
pygame.display.set_caption("لعبة الثعبان والأفعى")
...
def score_display(score):
    value = score_font.render("النقاط: " + str(score), True, GREEN)
...
game_loop()mport and Initialize
