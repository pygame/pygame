 ...
 *         if err < 0: raise Exception, Pm_GetErrorText(err)
 */
  __pyx_t_1 = __Pyx_PyInt_AsLong(__pyx_v_filters); if (unlikely((__pyx_t_1 == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 371; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_err = Pm_SetFilter(((struct __pyx_obj_4pypm_Input *)__pyx_v_self)->midi, __pyx_t_1);

  /* "pygame/trunk/src/pypm.pyx":373
 *         err = Pm_SetFilter(self.midi, filters)
 * 
 *         if err < 0: raise Exception, Pm_GetErrorText(err)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = (__pyx_v_err < 0);
  if (__pyx_t_2) {
    __pyx_t_3 = __Pyx_PyBytes_FromString(Pm_GetErrorText(__pyx_v_err)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 373; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_builtin_Exception, __pyx_t_3, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  while (1) {
    __pyx_t_2 = (Pm_Poll(((struct __pyx_obj_4pypm_Input *)__pyx_v_self)->midi) != pmNoError);
    if (!__pyx_t_2) break;

    /* "pygame/trunk/src/pypm.pyx":377
 *         while(Pm_Poll(self.midi) != pmNoError):
 * 
 *             err = Pm_Read(self.midi,buffer,1)             # <<<<<<<<<<<<<<
 *             if err < 0: raise Exception, Pm_GetErrorText(err)
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyInt_AsInt(__pyx_v_mask); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 395; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_err = Pm_SetChannelMask(((struct __pyx_obj_4pypm_Input *)__pyx_v_self)->midi, __pyx_t_1);

  /* "pygame/trunk/src/pypm.pyx":396
 *         cdef PmError err
 *         err = Pm_SetChannelMask(self.midi,mask)
 *         if err < 0: raise Exception, Pm_GetErrorText(err)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = (__pyx_v_err < 0);
  if (__pyx_t_2) {
    __pyx_t_3 = __Pyx_PyBytes_FromString(Pm_GetErrorText(__pyx_v_err)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 396; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_builtin_Exception, __pyx_t_3, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  ...
  if (__pyx_t_1) {
    __pyx_t_2 = __Pyx_PyBytes_FromString(Pm_GetErrorText(__pyx_v_err)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 405; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_Raise(__pyx_builtin_Exception, __pyx_t_2, 0);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = PyInt_FromLong(__pyx_v_err); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 406; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
 ...
 */
  __pyx_t_1 = PyObject_RichCompare(__pyx_v_length, __pyx_int_1024, Py_GT); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 420; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __pyx_t_1 = PyObject_RichCompare(__pyx_v_length, __pyx_int_1, Py_LT); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 421; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *         x=[]
 */
  __pyx_t_3 = __Pyx_PyInt_AsLong(__pyx_v_length); if (unlikely((__pyx_t_3 == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 422; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_1 = PyInt_FromLong(Pm_Read(((struct __pyx_obj_4pypm_Input *)__pyx_v_self)->midi, __pyx_v_buffer, __pyx_t_3)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 422; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_NumEvents);
  __pyx_v_NumEvents = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "pygame/trunk/src/pypm.pyx":423
 *         if length < 1: raise IndexError, 'minimum buffer length is 1'
 *         NumEvents = Pm_Read(self.midi,buffer,length)
 *         if NumEvents < 0: raise Exception, Pm_GetErrorText(NumEvents)             # <<<<<<<<<<<<<<
 *         x=[]
 *         if NumEvents >= 1:
 */
  __pyx_t_1 = PyObject_RichCompare(__pyx_v_NumEvents, __pyx_int_0, Py_LT); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 423; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (__pyx_t_2) {
    __pyx_t_4 = ((PmError)PyInt_AsLong(__pyx_v_NumEvents)); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 423; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __pyx_t_1 = __Pyx_PyBytes_FromString(Pm_GetErrorText(__pyx_t_4)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 423; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __pyx_t_1 = PyObject_RichCompare(__pyx_v_NumEvents, __pyx_int_1, Py_GE); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 425; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
    ...
    __pyx_t_6 = PyObject_Call(__pyx_builtin_range, ((PyObject *)__pyx_t_1), NULL); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 426; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
    if (PyList_CheckExact(__pyx_t_6) || PyTuple_CheckExact(__pyx_t_6)) {
      __pyx_t_5 = 0; __pyx_t_1 = __pyx_t_6; __Pyx_INCREF(__pyx_t_1);
    } else {
      __pyx_t_5 = -1; __pyx_t_1 = PyObject_GetIter(__pyx_t_6); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 426; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
    }
    ...
    for (;;) {
      ...
      /* "pygame/trunk/src/pypm.pyx":427
 *         if NumEvents >= 1:
 *             for loop in range(NumEvents):
 *                  x.append([[buffer[loop].message & 0xff, (buffer[loop].message >> 8) & 0xFF, (buffer[loop].message >> 16) & 0xFF, (buffer[loop].message >> 24) & 0xFF], buffer[loop].timestamp])             # <<<<<<<<<<<<<<
 *         return x
 */
      __pyx_t_7 = __Pyx_PyIndex_AsSsize_t(__pyx_v_loop); if (unlikely((__pyx_t_7 == (Py_ssize_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 427; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __pyx_t_6 = PyInt_FromLong(((__pyx_v_buffer[__pyx_t_7]).message & 0xff)); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 427; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_7 = __Pyx_PyIndex_AsSsize_t(__pyx_v_loop); if (unlikely((__pyx_t_7 == (Py_ssize_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 427; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __pyx_t_8 = PyInt_FromLong((((__pyx_v_buffer[__pyx_t_7]).message >> 8) & 0xFF)); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 427; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_8);
      __pyx_t_7 = __Pyx_PyIndex_AsSsize_t(__pyx_v_loop); if (unlikely((__pyx_t_7 == (Py_ssize_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 427; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __pyx_t_9 = PyInt_FromLong((((__pyx_v_buffer[__pyx_t_7]).message >> 16) & 0xFF)); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 427; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_9);
      __pyx_t_7 = __Pyx_PyIndex_AsSsize_t(__pyx_v_loop); if (unlikely((__pyx_t_7 == (Py_ssize_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 427; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __pyx_t_10 = PyInt_FromLong((((__pyx_v_buffer[__pyx_t_7]).message >> 24) & 0xFF)); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 427; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_10);
      __pyx_t_11 = PyList_New(4); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 427; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      ...
      __pyx_t_10 = 0;
      __pyx_t_7 = __Pyx_PyIndex_AsSsize_t(__pyx_v_loop); if (unlikely((__pyx_t_7 == (Py_ssize_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 427; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __pyx_t_10 = PyInt_FromLong((__pyx_v_buffer[__pyx_t_7]).timestamp); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 427; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_10);
      __pyx_t_9 = PyList_New(2); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 427; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      ...
      __pyx_t_11 = 0;
      __pyx_t_10 = 0;
      __pyx_t_10 = __Pyx_PyObject_Append(__pyx_v_x, ((PyObject *)__pyx_t_9)); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 427; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_10);
...
static int __Pyx_InitCachedBuiltins(void) {
  __pyx_builtin_Exception = __Pyx_GetName(__pyx_b, __pyx_kp_Exception); if (!__pyx_builtin_Exception) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 226; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_builtin_IndexError = __Pyx_GetName(__pyx_b, __pyx_kp_IndexError); if (!__pyx_builtin_IndexError) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 259; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_4pypm_Output) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 193; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetAttrString(__pyx_m, "Output", (PyObject *)&__pyx_type_4pypm_Output) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 193; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_4pypm_Output = &__pyx_type_4pypm_Output;
  if (PyType_Ready(&__pyx_type_4pypm_Input) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 322; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetAttrString(__pyx_m, "Input", (PyObject *)&__pyx_type_4pypm_Input) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 322; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_4pypm_Input = &__pyx_type_4pypm_Input;
  /*--- Type import code ---*/
  /*--- Function import code ---*/
  /*--- Execution code ---*/

  /* "pygame/trunk/src/pypm.pyx":7
 ...
 * FILT_CLOCK=0x4
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FILT_ACTIVE, __pyx_int_0x1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":101
 * 
 * FILT_ACTIVE=0x1
 * FILT_SYSEX=0x2             # <<<<<<<<<<<<<<
 * FILT_CLOCK=0x4
 * FILT_PLAY=0x8
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FILT_SYSEX, __pyx_int_0x2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":102
 * FILT_ACTIVE=0x1
 * FILT_SYSEX=0x2
 * FILT_CLOCK=0x4             # <<<<<<<<<<<<<<
 * FILT_PLAY=0x8
 * FILT_F9=0x10
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FILT_CLOCK, __pyx_int_0x4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":103
 * FILT_SYSEX=0x2
 * FILT_CLOCK=0x4
 * FILT_PLAY=0x8             # <<<<<<<<<<<<<<
 * FILT_F9=0x10
 * FILT_TICK=0x10
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FILT_PLAY, __pyx_int_0x8) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 103; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":104
 * FILT_CLOCK=0x4
 * FILT_PLAY=0x8
 * FILT_F9=0x10             # <<<<<<<<<<<<<<
 * FILT_TICK=0x10
 * FILT_FD=0x20
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_4, __pyx_int_0x10) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 104; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":105
 * FILT_PLAY=0x8
 * FILT_F9=0x10
 * FILT_TICK=0x10             # <<<<<<<<<<<<<<
 * FILT_FD=0x20
 * FILT_UNDEFINED=0x30
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FILT_TICK, __pyx_int_0x10) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":106
 * FILT_F9=0x10
 * FILT_TICK=0x10
 * FILT_FD=0x20             # <<<<<<<<<<<<<<
 * FILT_UNDEFINED=0x30
 * FILT_RESET=0x40
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FILT_FD, __pyx_int_0x20) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 106; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":107
 * FILT_TICK=0x10
 * FILT_FD=0x20
 * FILT_UNDEFINED=0x30             # <<<<<<<<<<<<<<
 * FILT_RESET=0x40
 * FILT_REALTIME=0x7F
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FILT_UNDEFINED, __pyx_int_0x30) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 107; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":108
 * FILT_FD=0x20
 * FILT_UNDEFINED=0x30
 * FILT_RESET=0x40             # <<<<<<<<<<<<<<
 * FILT_REALTIME=0x7F
 * FILT_NOTE=0x80
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FILT_RESET, __pyx_int_0x40) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 108; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":109
 * FILT_UNDEFINED=0x30
 * FILT_RESET=0x40
 * FILT_REALTIME=0x7F             # <<<<<<<<<<<<<<
 * FILT_NOTE=0x80
 ...
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FILT_REALTIME, __pyx_int_0x7F) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 109; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":110
 * FILT_RESET=0x40
 * FILT_REALTIME=0x7F
 * FILT_NOTE=0x80             # <<<<<<<<<<<<<<
 * FILT_CHANNEL_AFTERTOUCH=0x100
 ...
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FILT_NOTE, __pyx_int_0x80) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 110; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":111
 * FILT_REALTIME=0x7F
 * FILT_NOTE=0x80
 * FILT_CHANNEL_AFTERTOUCH=0x100             # <<<<<<<<<<<<<<
 * FILT_POLY_AFTERTOUCH=0x200
 ...
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_5, __pyx_int_0x100) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":112
 * FILT_NOTE=0x80
 * FILT_CHANNEL_AFTERTOUCH=0x100
 * FILT_POLY_AFTERTOUCH=0x200             # <<<<<<<<<<<<<<
 * FILT_AFTERTOUCH=0x300
 * FILT_PROGRAM=0x400
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_6, __pyx_int_0x200) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 112; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":113
 * FILT_CHANNEL_AFTERTOUCH=0x100
 * FILT_POLY_AFTERTOUCH=0x200
 * FILT_AFTERTOUCH=0x300             # <<<<<<<<<<<<<<
 * FILT_PROGRAM=0x400
 * FILT_CONTROL=0x800
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FILT_AFTERTOUCH, __pyx_int_0x300) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":114
 * FILT_POLY_AFTERTOUCH=0x200
 * FILT_AFTERTOUCH=0x300
 * FILT_PROGRAM=0x400             # <<<<<<<<<<<<<<
 * FILT_CONTROL=0x800
 ...
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FILT_PROGRAM, __pyx_int_0x400) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 114; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":115
 * FILT_AFTERTOUCH=0x300
 * FILT_PROGRAM=0x400
 * FILT_CONTROL=0x800             # <<<<<<<<<<<<<<
 * FILT_PITCHBEND=0x1000
 * FILT_MTC=0x2000
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FILT_CONTROL, __pyx_int_0x800) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":116
 * FILT_PROGRAM=0x400
 * FILT_CONTROL=0x800
 * FILT_PITCHBEND=0x1000             # <<<<<<<<<<<<<<
 * FILT_MTC=0x2000
 ...
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FILT_PITCHBEND, __pyx_int_0x1000) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 116; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":117
 * FILT_CONTROL=0x800
 * FILT_PITCHBEND=0x1000
 * FILT_MTC=0x2000             # <<<<<<<<<<<<<<
 * FILT_SONG_POSITION=0x4000
 ...
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FILT_MTC, __pyx_int_0x2000) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":118
 * FILT_PITCHBEND=0x1000
 * FILT_MTC=0x2000
 * FILT_SONG_POSITION=0x4000             # <<<<<<<<<<<<<<
 * FILT_SONG_SELECT=0x8000
 * FILT_TUNE=0x10000
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FILT_SONG_POSITION, __pyx_int_0x4000) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 118; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":119
 * FILT_MTC=0x2000
 * FILT_SONG_POSITION=0x4000
 * FILT_SONG_SELECT=0x8000             # <<<<<<<<<<<<<<
 * FILT_TUNE=0x10000
 * FALSE=0
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FILT_SONG_SELECT, __pyx_int_0x8000) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 119; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":120
 * FILT_SONG_POSITION=0x4000
 * FILT_SONG_SELECT=0x8000
 * FILT_TUNE=0x10000             # <<<<<<<<<<<<<<
 * FALSE=0
 * TRUE=1
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FILT_TUNE, __pyx_int_0x10000) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 120; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":121
 * FILT_SONG_SELECT=0x8000
 * FILT_TUNE=0x10000
 * FALSE=0             # <<<<<<<<<<<<<<
 * TRUE=1
 * 
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_FALSE, __pyx_int_0) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 121; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pygame/trunk/src/pypm.pyx":122
 * FILT_TUNE=0x10000
 * FALSE=0
 * TRUE=1             # <<<<<<<<<<<<<<
 * 
 * def Initialize():
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_TRUE, __pyx_int_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 122; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
