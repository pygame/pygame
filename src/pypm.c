 ...
 */
        ...
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_t_3 = __Pyx_PyInt_AndObjC(__pyx_t_2, __pyx_int_255, 0xFF, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 414, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initpypm(void); /*proto*/
__Pyx_PyMODINIT_FUNC initpypm(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_pypm(void); /*proto*/
