...
#define PYGAME_SDLCONSTANTS_INTERNAL
...
#endif
{
    ...
    static struct PyModuleDef _module = {
        PyModuleDef_HEAD_INIT, "constants", "Pygame SDL constants", -1, NULL,
        NULL, NULL, NULL, NULL
    };
    module = PyModule_Create (&_module);
#else
    module = Py_InitModule3 ("constants", NULL, "Pygame SDL constants");
#endif
    if (!module)
        goto fail;
    ...
    DEC_CONST (ALPHA_OPAQUE);
    DEC_CONST (ALPHA_TRANSPARENT);
...
/*     PyModule_AddIntConstant(module, "SCRAP_SELECTION", 1); */
    ...
    DEC_CONSTN(BLEND_RGBA_AND);
    DEC_CONSTN(BLEND_RGBA_OR);
    DEC_CONSTN(BLEND_RGBA_XOR);
    DEC_CONSTN(BLEND_RGBA_DIFF);
    DEC_CONSTN(BLEND_RGBA_SCREEN);
    DEC_CONSTN(BLEND_RGBA_AVG);
    ...
    DEC_CONSTN(PYGAME_USEREVENT);
    DEC_CONSTN(PYGAME_USEREVENT_CODE);
