...
#define PYGAME_BLEND_ALPHA_SDL2 0x12
    ...
    DEC_CONSTS(WINDOWMINIMISED, PGE_WINDOWMINIMISED);
    DEC_CONSTS(WINDOWMAXIMISED, PGE_WINDOWMAXIMISED);
    ...
    DEC_CONST(WINDOWEVENT_SHOWN);
    DEC_CONST(WINDOWEVENT_HIDDEN);
    DEC_CONST(WINDOWEVENT_EXPOSED);
    DEC_CONST(WINDOWEVENT_MOVED);
    DEC_CONST(WINDOWEVENT_RESIZED);
    DEC_CONST(WINDOWEVENT_SIZE_CHANGED);
    DEC_CONST(WINDOWEVENT_MINIMIZED);
    DEC_CONST(WINDOWEVENT_MAXIMIZED);
    DEC_CONST(WINDOWEVENT_RESTORED);
    DEC_CONST(WINDOWEVENT_ENTER);
    DEC_CONST(WINDOWEVENT_LEAVE);
    DEC_CONST(WINDOWEVENT_FOCUS_GAINED);
    DEC_CONST(WINDOWEVENT_FOCUS_LOST);
    DEC_CONST(WINDOWEVENT_CLOSE);
    #if SDL_VERSION_ATLEAST(2, 0, 5)
        DEC_CONST(WINDOWEVENT_TAKE_FOCUS);
        DEC_CONST(WINDOWEVENT_HIT_TEST);
    #else
        DEC_CONSTS(WINDOWEVENT_TAKE_FOCUS, -1);
        DEC_CONSTS(WINDOWEVENT_HIT_TEST, -1);
    ...
    DEC_CONSTS(WINDOWMINIMISED, -1);
    DEC_CONSTS(WINDOWMAXIMISED, -1);
    ...
    DEC_CONSTS(WINDOWEVENT_SHOWN, -1);
    DEC_CONSTS(WINDOWEVENT_HIDDEN, -1);
    DEC_CONSTS(WINDOWEVENT_EXPOSED, -1);
    DEC_CONSTS(WINDOWEVENT_MOVED, -1);
    DEC_CONSTS(WINDOWEVENT_RESIZED, -1);
    DEC_CONSTS(WINDOWEVENT_SIZE_CHANGED, -1);
    DEC_CONSTS(WINDOWEVENT_MINIMIZED, -1);
    DEC_CONSTS(WINDOWEVENT_MAXIMIZED, -1);
    DEC_CONSTS(WINDOWEVENT_RESTORED, -1);
    DEC_CONSTS(WINDOWEVENT_ENTER, -1);
    DEC_CONSTS(WINDOWEVENT_LEAVE, -1);
    DEC_CONSTS(WINDOWEVENT_FOCUS_GAINED, -1);
    DEC_CONSTS(WINDOWEVENT_FOCUS_LOST, -1);
