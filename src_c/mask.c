...
static PyMethodDef mask_methods[] = {
    ...
    {"get_rect", (PyCFunction)mask_get_rect, METH_VARARGS | METH_KEYWORDS,
     DOC_MASKGETRECT},
    {"get_at", mask_get_at, METH_VARARGS | METH_KEYWORDS, DOC_MASKGETAT},
    {"set_at", mask_set_at, METH_VARARGS | METH_KEYWORDS, DOC_MASKSETAT},
    {"overlap", mask_overlap, METH_VARARGS | METH_KEYWORDS, DOC_MASKOVERLAP},
    {"overlap_area", mask_overlap_area, METH_VARARGS | METH_KEYWORDS, DOC_MASKOVERLAPAREA},
    {"overlap_mask", mask_overlap_mask, METH_VARARGS | METH_KEYWORDS, DOC_MASKOVERLAPMASK},
    ...
    {"scale", mask_scale, METH_VARARGS | METH_KEYWORDS, DOC_MASKSCALE},
    {"draw", mask_draw, METH_VARARGS | METH_KEYWORDS, DOC_MASKDRAW},
    {"erase", mask_erase, METH_VARARGS | METH_KEYWORDS, DOC_MASKERASE},
    ...
    {"outline", mask_outline, METH_VARARGS | METH_KEYWORDS, DOC_MASKOUTLINE},
    {"convolve", mask_convolve, METH_VARARGS | METH_KEYWORDS, DOC_MASKCONVOLVE},
    {"connected_component", mask_connected_component, METH_VARARGS | METH_KEYWORDS,
     DOC_MASKCONNECTEDCOMPONENT},
    {"connected_components", mask_connected_components, METH_VARARGS | METH_KEYWORDS,
...
static PyMethodDef _mask_methods[] = {
    {"from_surface", mask_from_surface, METH_VARARGS | METH_KEYWORDS,
     DOC_PYGAMEMASKFROMSURFACE},
    {"from_threshold", mask_from_threshold, METH_VARARGS | METH_KEYWORDS,
