...
#define DOC_PYGAMEDRAWARC "arc(surface=Surface, color=Color, rect=Rect, start_angle=radians, stop_angle=radians) -> Rect\narc(surface=Surface, color=Color, rect=Rect, start_angle=radians, stop_angle=radians, width=1) -> Rect\ndraw an elliptical arc"
...
pygame.draw.arc
 arc(surface=Surface, color=Color, rect=Rect, start_angle=radians, stop_angle=radians) -> Rect
 arc(surface=Surface, color=Color, rect=Rect, start_angle=radians, stop_angle=radians, width=1) -> Rect
draw an elliptical arc
