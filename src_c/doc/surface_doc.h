...
#define DOC_SURFACEUBLITS "ublits(blit_sequence=((source, dest), ...), special_flags=0, doreturn=1) -> [Rect, ...] or None\ndraw many images onto another, all with the full rect and the same special_flags"
...
pygame.Surface.ublits
 ublits(blit_sequence=((source, dest), ...), special_flags=0, doreturn=1) -> [Rect, ...] or None
 ublits(((source, dest), ...)) -> [Rect, ...] or None
draw many images onto another, all with the full rect and the same special_flags
