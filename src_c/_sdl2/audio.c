 ...
 */
          ...
          __pyx_t_3 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_nn_Uint8); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 84, __pyx_L7_error)
          __Pyx_GOTREF(__pyx_t_3);
          __pyx_t_2 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)__pyx_v_len)); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 84, __pyx_L7_error)
