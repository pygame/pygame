...
/*
 * Compat thing for controller (see https://github.com/pygame/pygame/pull/3238)
 */
#ifndef PG_GameControllerRumble
static int
                        ...
                        Uint16 high_frequency_rumble, Uint32 duration_ms)
{
    ...
    return SDL_GameControllerRumble(gamecontroller, low_frequency_rumble, high_frequency_rumble, duration_ms);
#else
    return -1;
#endif
}
