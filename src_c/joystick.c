...
static PyMethodDef joy_methods[] = {
    {"init", joy_init, METH_NOARGS, DOC_JOYSTICKTYPEINIT},
    {"quit", joy_quit, METH_NOARGS, DOC_JOYSTICKTYPEQUIT},
    {"get_init", joy_get_init, METH_NOARGS, DOC_JOYSTICKTYPEGETINIT},

    {"get_id", joy_get_id, METH_NOARGS, DOC_JOYSTICKTYPEGETID},
    {"get_instance_id", joy_get_instance_id, METH_NOARGS,
     DOC_JOYSTICKTYPEGETINSTANCEID},
    {"get_guid", joy_get_guid, METH_NOARGS, DOC_JOYSTICKTYPEGETGUID},
    {"get_power_level", joy_get_power_level, METH_NOARGS,
     DOC_JOYSTICKTYPEGETPOWERLEVEL},
    {"rumble", (PyCFunction)joy_rumble, METH_VARARGS | METH_KEYWORDS,
     DOC_JOYSTICKTYPERUMBLE},
    {"stop_rumble", (PyCFunction)joy_stop_rumble, METH_NOARGS,
     DOC_JOYSTICKTYPESTOPRUMBLE},
    {"get_name", joy_get_name, METH_NOARGS, DOC_JOYSTICKTYPEGETNAME},

    {"get_numaxes", joy_get_numaxes, METH_NOARGS, DOC_JOYSTICKTYPEGETNUMAXES},
    {"get_axis", joy_get_axis, METH_VARARGS, DOC_JOYSTICKTYPEGETAXIS},
    {"get_numbuttons", joy_get_numbuttons, METH_NOARGS,
     DOC_JOYSTICKTYPEGETNUMBUTTONS},
    {"get_button", joy_get_button, METH_VARARGS, DOC_JOYSTICKTYPEGETBUTTON},
    {"get_numballs", joy_get_numballs, METH_NOARGS, DOC_JOYSTICKTYPEGETNUMBALLS},
    {"get_ball", joy_get_ball, METH_VARARGS, DOC_JOYSTICKTYPEGETBALL},
    {"get_numhats", joy_get_numhats, METH_NOARGS, DOC_JOYSTICKTYPEGETNUMHATS},
    {"get_hat", joy_get_hat, METH_VARARGS, DOC_JOYSTICKTYPEGETHAT},
