...
if [ "$(uname -i)" = "x86_64" ]; then
    ...
    RPMFORGE_URL="https://repoforge.cu.be/redhat/el5/en/x86_64/dag/RPMS/${RPMFORGE_FILE}"
else
    RPMFORGE_FILE="rpmforge-release-0.5.3-1.el5.rf.i386.rpm"
    RPMFORGE_URL="https://repoforge.cu.be/redhat/el5/en/i386/dag/RPMS/${RPMFORGE_FILE}"
fi
